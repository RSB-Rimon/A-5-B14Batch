...
const TechnolgyCard = ({ technologys }) => {
  ...
  <div className="card-body p-5">
    ...
    {/* Button */}
    <button className="mt-3 w-full rounded-lg bg-slate-950 py-2.5 text-sm font-medium text-white transition hover:bg-slate-800">
      Add to Stack
    </button>
